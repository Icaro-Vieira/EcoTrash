function apiCep() {
  const inputCep = document.querySelector("#cepSc");
  ...
  inputCep.addEventListener("blur", function (event) {
    ...
    fetch(`https://viacep.com.br/ws/${cep}/json/`)
      ...
      .then((fields) => {
          document.querySelector("#logradouroPontoSc").value = fields.logradouro;
          document.querySelector("#bairroPontoSc").value = fields.bairro;
        });
  });
}
